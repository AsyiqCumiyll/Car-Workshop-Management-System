...
public class BookingServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String insertQuery = "INSERT INTO bookings (car_owner_name, car_plate_number, phone, car_model, service_type) VALUES (?, ?, ?, ?, ?)";
        ...
        try (Connection connection = DBConnection.getConnection();
            ...
            if (connection == null || connection.isClosed()) {
                ...
                response.sendRedirect(request.getContextPath() + "/Booking_Appoiment.jsp?message=db_error");
                return;
            }
            ...
            // Error occurred, forward to booking page with context
            RequestDispatcher dispatcher = request.getRequestDispatcher("/Booking_Appoiment.jsp");
            dispatcher.forward(request, response);
        }
    }
