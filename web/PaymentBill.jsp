...
if ("POST".equalsIgnoreCase(request.getMethod())) {
    ...
    try {
        ...
        left.addElement(new Paragraph("Your Company Name", labelFont));
        left.addElement(new Paragraph("Address:\nCity:\nCountry:\nPostal:", textFont));
        infoTable.addCell(left);

        PdfPCell right = new PdfPCell();
        right.setBorder(Rectangle.NO_BORDER);
        right.addElement(new Paragraph("Details", labelFont));
        right.addElement(new Paragraph("Receipt No: -\nReceipt Date: -\nPayment Date: -", textFont));
